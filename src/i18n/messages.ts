...
const en = {
  ...
  loginWithPassword: "Login with username/password",
  loginWithTLS: "Login with TLS",
  username: "Username",
  password: "Password",
  invalidLoginCredentials: "Invalid username or password",
  backendCertificateNotTrusted:
    "Backend certificate is not trusted by Incus. Please add the gateway client certificate to trust list.",
...
const zhCN: MessageCatalog = {
  ...
  loginWithPassword: "使用账号密码登录",
  loginWithTLS: "使用 TLS 登录",
  username: "用户名",
  password: "密码",
  invalidLoginCredentials: "用户名或密码错误",
  backendCertificateNotTrusted:
    "后端证书未被 Incus 信任，请先将网关客户端证书加入 trust 列表。",
